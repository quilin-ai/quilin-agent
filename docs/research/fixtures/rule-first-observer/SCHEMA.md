...
- `docs/research/fixtures/rule-first-observer/SCHEMA.md`（本文件）
- `docs/research/fixtures/rule-first-observer/dataset.json`（分批产出）
- `docs/research/fixtures/rule-first-observer/README.md`（数据来源说明 + 版本历史）
