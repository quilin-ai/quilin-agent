...
>
> **状态校准（2026-04-30）**：本文是 AgentMesh 独立项目的历史设计材料，不代表 Quilin 当前已实现 runtime。Quilin 侧当前只在 Iter D 落地 `crates/mesh-sdk` stub + CI；AgentMesh runtime / meshd / discovery / crypto / push adapter 均延期到 Iter F Day 0 spike。
