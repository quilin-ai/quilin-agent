...
Dataset:
- `docs/03-memory/l3a-observer/fixtures/dataset.json` (1039 samples)

Baseline source reused:
- `.spike/observer/results-v2-r3.json`
- `docs/03-memory/l3a-observer/rule-first-observer-spike-report.md`

Output:
- `docs/03-memory/l3a-observer/tier1-tiny-llm-spike/results.json`
