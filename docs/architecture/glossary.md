...
> **D-10 / R-08（2026-04-18）**：本文件是 Quilin Agent 文档的**规范术语源**，由 `scripts/lint-glossary.py` 与 `markdown-link-check` 在 CI 中强制检查。新增/修改术语请先改本文件，再扫描全库对齐。
...
| 标签 | 含义 |
|------|------|
| ✅ 已实现 | 代码已合入 `packages/` 或 `providers/` |
| 🚧 进行中 | 有活跃 Iter 票据且代码部分落地 |
| 💭 未开始 | 仅 spec，无代码 |
...
**Last reviewed:** 2026-04-19 (Opus 4.7 review, D-10 / R-08 landing + FEA-04 tier alignment)
